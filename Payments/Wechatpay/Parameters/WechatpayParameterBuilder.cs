...
namespace Dotnet.Services.Pay.Payments.Wechatpay.Parameters {
    /// <summary>
    /// 微信支付参数生成器
    /// </summary>
    public class WechatpayParameterBuilder {
        ...
        public WechatpayParameterBuilder TotalFee( decimal totalFee ) {
            _builder.Add( WechatpayConst.TotalFee, ConvertUtil.ToInt32( totalFee * 100,0 ) );
            return this;
        }
        ...
        public WechatpayParameterBuilder Timestamp( long timestamp = 0 ) {
            _builder.Add( WechatpayConst.Timestamp, timestamp == 0 ? DateTimeUtil.GetUnixTimestamp() : timestamp );
            return this;
        }
        ...
        /// 添加Xml节点
        /// </summary>
        private void AddNode(XmlUtil xml, string key, object value ) {
        ...
        public string ToJson() {
            return _jsonSerializer.Serialize(GetSignBuilder());
        }
