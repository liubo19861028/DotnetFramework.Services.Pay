...
namespace Dotnet.Services.Pay.Payments.Alipay.Parameters {
    /// <summary>
    /// 支付宝参数生成器
    /// </summary>
    public class AlipayParameterBuilder {
        ...
        private AlipayParameterBuilder Timestamp() {
            _builder.Add( AlipayConst.Timestamp, System.DateTime.Now );
            return this;
        }
        ...
        private UrlParameterBuilder GetSignBuilder( bool isConvertToSingleQuotes = false ) {
            ...
            if( Content.IsEmpty == false )
                builder.Add( AlipayConst.BizContent, _jsonSerializer.Serialize( isConvertToSingleQuotes ) );
